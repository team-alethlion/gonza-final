          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        If you need assistance with logging in or have any other questions, please contact our support team.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                      ...
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>Having trouble with Google Sign-in? Make sure you have a valid Google account.</li>
                      </ul>
                ...
                >
                  {resetEmailLoading ? 'Sending...' : resetEmailSent ? 'Email sent!' : 'Forgot password?'}
                </Button>
              </div>
