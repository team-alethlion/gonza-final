...
const CustomersClient = ({ initialCustomers, initialCount }: { initialCustomers?: Customer[], initialCount?: number }) => {
  const { user } = useAuth();
  const { currentBusiness, isLoading: businessLoading } = useBusiness();
  const { customers, isLoading, createCustomer, updateCustomer, deleteCustomer, page, setPage, pageSize, setPageSize, totalCount } = useCustomers(50, { customers: initialCustomers || [], count: initialCount || 0 });
