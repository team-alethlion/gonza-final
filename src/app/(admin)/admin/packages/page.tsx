...
export default function AdminPackagesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(
          `Package ${editingPkg ? "updated" : "created"} successfully`,
        );
        setIsAdding(false);
        setEditingPkg(null);
        queryClient.invalidateQueries({ queryKey: ["admin-packages"] });
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <p className="text-slate-500 text-sm font-medium">
              Create and manage tiers for your business clients.
            </p>
          </div>
          <button
            onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-l-2 border-blue-600 pl-3">
                      General Information
                    </h3>
                  ...
                  <div className="space-y-6">
                    <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-l-2 border-amber-500 pl-3">
                      Resource Quotas
                    </h3>
                      ...
                      <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setForm({
                                ...formData,
                                unlimitedSales: e.target.checked,
                              })
                            }
                            className="rounded text-blue-600"
                          />
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({
                              ...formData,
                              maxSalesPerMonth: Number(e.target.value),
                            })
                          }
                          className="w-full h-10 px-3 rounded-lg border border-slate-200 font-bold disabled:opacity-50"
                        />
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50 border-b border-slate-100">
                    ...
                    <th className="px-6 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center">
                      Pricing
                    </th>
                    <th className="px-6 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center">
                      Limits
                      ...
                      <tr
                        ...
                        <td className="px-8 py-6">
                          <div className="space-y-1">
                            <div className="flex items-center gap-2">
                              ...
                              {pkg.isDefault && (
                                <span className="px-2 py-0.5 bg-blue-50 text-blue-600 rounded-md text-[8px] font-bold uppercase border border-blue-100">
                                  Default
                                </span>
                              )}
                            </div>
                        ...
                        <td className="px-6 py-6 text-center">
                          <div className="space-y-0.5">
                            <p className="text-sm font-bold text-slate-900">
                              UGX {pkg.monthlyPrice.toLocaleString()}
                            </p>
                            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-tighter">
                              UGX {pkg.yearlyPrice.toLocaleString()} / Yr
                            </p>
                          </div>
                        </td>
                        <td className="px-6 py-6">
                          <div className="flex flex-wrap justify-center gap-2">
                            ...
                            <div className="px-2 py-1 bg-slate-100 rounded-md text-[9px] font-bold text-slate-600 uppercase">
                              {pkg.unlimitedProducts ? "∞" : pkg.maxProducts}{" "}
                              Prods
                            </div>
                          </div>
                        </td>
                        ...
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-slate-500 text-sm max-w-xs">
                              Create your first subscription tier to allow
                              businesses to onboard and pay for your services.
                            </p>
                          </div>
                          <button
