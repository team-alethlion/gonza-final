      ...
      <div
        ...
        <div className="relative z-10 mt-auto mb-auto space-y-6 max-w-sm">
          ...
          <p className="text-white/70 text-sm leading-relaxed">
            Internal administrative terminal for managing enterprise operations,
            entity verification, and system parameters across the Gonza
            ecosystem.
          </p>
        </div>
        ...
        <div className="w-full max-w-[360px] animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-[10px] text-muted-foreground/40 leading-relaxed px-4">
              By signing in, you agree to the protocols governing internal data
              processing and security compliance.
            </p>
          </div>
        </div>
      </div>
