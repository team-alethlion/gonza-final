...
export const AuthProvider: React.FC<{ children: React.ReactNode; adminPathSecret?: string }> = ({ children, adminPathSecret }) => {
    ...
    const signOut = async () => {
        const callbackUrl = adminPathSecret ? `/admin/${adminPathSecret}` : '/login';
