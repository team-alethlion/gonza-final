...
import { HelpCircle, Mail, Phone, Eye, EyeOff, ShieldCheck, Timer, RefreshCw } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { initiateSignupAction, verifyAndCreateAccountAction } from "@/app/actions/verification";
        ...
        <CardContent>
          ...
          <div className="relative my-6">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="bg-white px-2 text-xs text-muted-foreground uppercase tracking-wider">Or continue with</span>
            </div>
          </div>
