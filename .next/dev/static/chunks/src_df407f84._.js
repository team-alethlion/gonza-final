...
"[project]/src/utils/exportToCSV.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const exportToCSV = (sales)=>{
    ...
    const rows = sales.map((sale)=>{
        ...
        return [
            sale.receiptNumber,
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(sale.date), 'yyyy-MM-dd HH:mm'),
            sale.customerName,
            itemNames,
    ...
    if (link.download !== undefined) {
        ...
        link.setAttribute('download', `sales_export_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd_HHmm')}.csv`);
...
"[project]/src/utils/generateSalesReportVectorPDF.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const generateSalesReportVectorPDF = (salesData, period, currency = 'USD', dateRange, businessSettings)=>{
        ...
        salesData.forEach((sale)=>{
            ...
            sale.items.forEach((item, itemIndex)=>{
                ...
                const rowData = [
                    ...
                    itemIndex === 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(sale.sale_date), 'dd/MM/yyyy') : '',
    ...
    if (dateRange?.from && dateRange?.to) {
        ...
        // Fallback to current date if no range provided
        filename = `sales_report_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd')}.pdf`;
    }
    pdf.save(filename);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    ...
    try {
        ...
        const allItems = unpaidSales.flatMap((sale)=>{
            ...
            return sale.items.map((item)=>[
                    ...
                    `${settings.currency} ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(totalWithTax)}`
                ]);
        });
        // Add total row
        allItems.push([
            ...
            '',
            'TOTAL OUTSTANDING:',
            `${settings.currency} ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(totalAmountDue)}`,
            ''
        ]);
...
//# sourceMappingURL=src_df407f84._.js.map