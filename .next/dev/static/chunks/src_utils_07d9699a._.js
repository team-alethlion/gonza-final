...
const fetchInstallmentPayments = async (saleId)=>{
    try {
        const { data, error } = await supabase.from('installment_payments').select('id, amount, payment_date').eq('sale_id', saleId).order('payment_date', {
            ascending: false
        });
...
//# sourceMappingURL=src_utils_07d9699a._.js.map