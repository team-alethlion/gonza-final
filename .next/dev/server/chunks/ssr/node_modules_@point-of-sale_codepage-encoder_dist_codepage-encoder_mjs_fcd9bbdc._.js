module.exports = [
"[project]/node_modules/@point-of-sale/codepage-encoder/dist/codepage-encoder.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class CodepageEncoder {
     ...
     */ static getEncoding(codepage) {
        ...
        /* Create codepoints array if it doesn't exist */ if (typeof definitions[codepage].codepoints === 'undefined') {
            definitions[codepage].codepoints = this.getCodepoints(codepage, true);
        }
        /* Return codepage definition */ return structuredClone(definitions[codepage]);
    }
    /**
     ...
     */ static getTestStrings(codepage) {
        ...
        if (typeof definitions[codepage] !== 'undefined' && typeof definitions[codepage].languages !== 'undefined') {
...
//# sourceMappingURL=node_modules_%40point-of-sale_codepage-encoder_dist_codepage-encoder_mjs_fcd9bbdc._.js.map