module.exports = [
"[project]/node_modules/@point-of-sale/receipt-printer-encoder/dist/receipt-printer-encoder.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$dither$2f$src$2f$canvas$2d$dither$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/canvas-dither/src/canvas-dither.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$flatten$2f$src$2f$canvas$2d$flatten$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/canvas-flatten/src/canvas-flatten.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@point-of-sale/codepage-encoder/dist/codepage-encoder.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$canvas$2f$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@canvas/image-data/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$resize$2d$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/resize-image-data/index.js [app-ssr] (ecmascript)");
;
;
;
;
 ...
 */ class LanguageEscPos {
     ...
     */ barcode(value, symbology, options) {
        ...
        const symbologies = {
            ...
            'code39': 0x04,
            'coda39': 0x04,
            /* typo, leave here for backwards compatibility */ 'itf': 0x05,
        ...
        /* Calculate segment width */ if (options.width < 1 || options.width > 3) {
        ...
        /* Set barcode options */ result.push({
            type: 'barcode',
            property: 'height',
            ...
            payload: [
                0x1d,
                0x48,
                options.text ? 0x02 : 0x00
            ]
        });
        /* Encode barcode */ if (symbology == 'code128' && !value.startsWith('{')) {
            value = '{B' + value;
        }
        if (symbology == 'gs1-128') {
            value = value.replace(/[()*]/g, '');
        }
        const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, 'ascii');
        const identifier = typeof symbology === 'string' ? symbologies[symbology] : symbology;
        if (identifier > 0x40) {
            /* Function B symbologies */ result.push({
                type: 'barcode',
                value: {
                    symbology: symbology,
                    data: value
            ...
            /* Function A symbologies */ result.push({
                type: 'barcode',
                value: {
                    symbology: symbology,
                    data: value
     ...
     */ qrcode(value, options) {
        const result = [];
        /* Model */ if (typeof options.model === 'number') {
            const models = {
                1: 0x31,
                2: 0x32
            };
        ...
        /* Size */ if (typeof options.size !== 'number') {
        ...
        /* Data */ const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, 'iso8859-1');
     ...
     */ pdf417(value, options) {
        const result = [];
        /* Columns */ if (typeof options.columns !== 'number') {
        ...
        /* Rows */ if (typeof options.rows !== 'number') {
        ...
        /* Width */ if (typeof options.width !== 'number') {
        ...
        /* Height */ if (typeof options.height !== 'number') {
        ...
        /* Error level */ if (typeof options.errorlevel !== 'number') {
        ...
        /* Model: standard or truncated */ result.push({
            type: 'pdf417',
            property: 'truncated',
        ...
        /* Data */ const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, 'ascii');
        const length = bytes.length + 3;
        result.push({
            type: 'pdf417',
            property: 'data',
     ...
     */ image(image, width, height, mode) {
        ...
        /* Encode images with ESC * */ if (mode == 'column') {
            result.push({
                type: 'line-spacing',
                value: '24 dots',
                payload: [
        ...
        /* Encode images with GS v */ if (mode == 'raster') {
            result.push({
                type: 'image',
                command: 'data',
                value: 'raster',
 ...
 */ class LanguageStarPrnt {
     ...
     */ barcode(value, symbology, options) {
        ...
        /* Selecting mode A, B or C for Code128 is not supported for StarPRNT, so ignore it and let the printer choose */ if (symbology === 'code128' && value.startsWith('{')) {
            value = value.slice(2);
        }
        /* Encode the barcode value */ const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, 'ascii');
        const identifier = typeof symbology === 'string' ? symbologies[symbology] : symbology;
        result.push({
            type: 'barcode',
            value: {
     ...
     */ pdf417(value, options) {
        const result = [];
        /* Columns and Rows */ if (typeof options.columns !== 'number') {
            throw new Error('Columns must be a number');
        }
        if (options.columns !== 0 && (options.columns < 1 || options.columns > 30)) {
            throw new Error('Columns must be 0, or between 1 and 30');
     ...
     */ static wrap(value, options) {
        ...
        for (const value of lines){
            ...
            for (const chunk of chunks){
                ...
                /* The word does not fit on the line */ if (length + chunk.length * width > columns) {
                    /* The word is longer than the line */ if (chunk.length * width > columns) {
                        /* Calculate the remaining space on the line */ const remaining = columns - length;
                        /* Split the word into pieces */ const letters = chunk.split('');
                        let piece;
                        const pieces = [];
                        /* If there are at least 8 position remaining, break early  */ if (remaining > 8 * width) {
                        ...
                        /* The remaining letters can be split into pieces the size of the width */ while((piece = letters.splice(0, Math.floor(columns / width))).length){
                    ...
                    /* Word fits on the next line */ result.push(line);
                    line = [];
                    length = 0;
                }
                /* Check if we are whitespace */ if (chunk.match(/\s+/) && length == 0) {
                    continue;
                }
                line.push(chunk);
 ...
 */ class LineComposer {
     ...
     */ text(value, codepage) {
        ...
        for(let i = 0; i < lines.length; i++){
            if (lines[i].length) {
                /* Add the line to the buffer */ this.add({
                    type: 'text',
                    value: lines[i],
                    codepage
                }, lines[i].length * this.style.width);
                /* If it is not the last line, flush the buffer */ if (i < lines.length - 1) {
                    this.flush();
                }
            } else {
                /* In case the line is empty, flush the buffer */ this.flush({
                    forceNewline: true
                });
            }
        }
   ...
   */ space(size) {
     ...
     */ fetch(options) {
        /* Unless forced keep style changes for the next line */ if (this.#cursor === 0 && !options.forceNewline && !options.forceFlush) {
            return [];
        }
        /* Check the alignment of the current line */ const align = {
            current: this.#align,
            next: null
        };
        ...
        /* Check the last item in the buffer, to see if it changes the alignment, then save it for the next line */ if (this.#buffer.length) {
        ...
        /* Create a clean buffer without alignment changes */ const buffer = this.#buffer.filter((item)=>item.type !== 'align' || item.payload);
        /* Fetch the contents of the line buffer */ let result = [];
        ...
        if (this.#cursor === 0 && (options.ignoreAlignment || !this.#embedded)) {
            ...
            if (this.#align === 'right') {
                let last;
                /* Find index of last text or space element */ for(let i = buffer.length - 1; i >= 0; i--){
                    if (buffer[i].type === 'text' || buffer[i].type === 'space') {
                        last = i;
                        break;
                    }
                }
                /* Remove trailing spaces from lines */ if (typeof last === 'number') {
     ...
     */ #merge(items) {
        ...
        for (let item of items){
            ...
            if (item.type === 'text') {
                /* Check if we can merge the text with the last item */ const allowMerge = last >= 0 && result[last].type === 'text' && (result[last].codepage === item.codepage || result[last].codepage === null || item.codepage === null);
                if (allowMerge) {
                ...
                const allowMerge = last >= 0 && result[last].type === 'style' && result[last].property === 'size';
                if (allowMerge) {
                    result[last].value = item.value;
                    continue;
                }
 ...
 */ class ReceiptPrinterEncoder {
    ...
    */ constructor(options){
        ...
        /* Determine default settings based on the printer language */ if (typeof options.language === 'string') {
            defaults.columns = options.language === 'esc-pos' ? 42 : 48;
            defaults.codepageMapping = options.language === 'esc-pos' ? 'epson' : 'star';
        }
        /* Determine default settings based on the printer model */ if (typeof options.printerModel === 'string') {
            ...
            /* Apply the printer definition to the defaults */ defaults.columns = this.#printerCapabilities.fonts['A'].columns;
        ...
        /* Backwards compatibility for the width option */ if (this.#options.width) {
            this.#options.columns = this.#options.width;
        }
        /* Get the printer language */ if (this.#options.language === 'esc-pos') {
    ...
    */ if (typeof this.#options.autoFlush === 'undefined') {
        ...
        /* Check column width */ if (![
            32,
            35,
            42,
            44,
            48
        ].includes(this.#options.columns) && !this.#options.embedded) {
            throw new Error('The width of the paper must me either 32, 35, 42, 44 or 48 columns');
        }
        /* Determine codepage mapping and candidates */ if (typeof this.#options.codepageMapping === 'string') {
            ...
            this.#codepageMapping = Object.fromEntries(codepageMappings[this.#options.language][this.#options.codepageMapping].map((v, i)=>[
                    v,
                    i
                ]).filter((i)=>i));
        } else {
        ...
        /* Create our line composer */ this.#composer = new LineComposer({
    ...
    */ #reset() {
     ...
     */ codepage(codepage) {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].supports(codepage)) {
     ...
     *
     */ size(width, height) {
        /* Backwards compatiblity for changing the font */ if (typeof width === 'string') {
     ...
     */ font(value) {
        ...
        /* If size is specified, find the matching font */ const matches = value.match(/^[0-9]+x[0-9]+$/);
        if (matches) {
            value = Object.entries(this.#printerCapabilities.fonts).find((i)=>i[1].size == matches[0])[0];
        }
        /* Make sure the font name is uppercase */ value = value.toUpperCase();
        /* Check if the font is supported */ if (typeof this.#printerCapabilities.fonts[value] === 'undefined') {
            return this.#error('This font is not supported by this printer', 'relaxed');
        }
        /* Change the font */ this.#composer.add(this.#language.font(value));
        this.#state.font = value;
        /* Change the width of the composer */ if (value === 'A') {
            this.#composer.columns = this.#options.columns;
        } else {
            this.#composer.columns = this.#options.columns / this.#printerCapabilities.fonts['A'].columns * this.#printerCapabilities.fonts[value].columns;
        }
        return this;
    }
    /**
     ...
     */ table(columns, data) {
        this.#composer.flush();
        /* Process all lines */ for(let r = 0; r < data.length; r++){
            const lines = [];
            let maxLines = 0;
            /* Render all columns */ for(let c = 0; c < columns.length; c++){
                ...
                /* Determine the height in lines of the row */ maxLines = Math.max(maxLines, cell.length);
                lines[c] = cell;
            }
            /* Pad the cells in this line to the same height */ for(let c = 0; c < columns.length; c++){
            ...
            /* Add the lines to the composer */ for(let l = 0; l < maxLines; l++){
     ...
     */ box(options, contents) {
        ...
        /* Render the contents of the box */ const columnEncoder = new ReceiptPrinterEncoder(Object.assign({}, this.#options, {
     ...
     */ barcode(value, symbology, height) {
        ...
        /* Force printing the print buffer and moving to a new line */ this.#composer.flush({
            forceFlush: true,
            ignoreAlignment: true
        });
        /* Set alignment */ if (this.#composer.align !== 'left') {
            this.#composer.add(this.#language.align(this.#composer.align));
        }
        /* Barcode */ this.#composer.add(this.#language.barcode(value, symbology, options));
        /* Reset alignment */ if (this.#composer.align !== 'left') {
     ...
     */ qrcode(value, model, size, errorlevel) {
        ...
        /* QR code */ this.#composer.add(this.#language.qrcode(value, options));
        /* Reset alignment */ if (this.#composer.align !== 'left') {
            this.#composer.add(this.#language.align('left'));
        }
        this.#composer.flush({
     ...
     */ pdf417(value, options) {
        ...
        if (this.#printerCapabilities.pdf417.supported === false) {
            /* If possible, fallback to a barcode with symbology */ if (typeof this.#printerCapabilities.pdf417.fallback === 'object') {
        ...
        /* PDF417 code */ this.#composer.add(this.#language.pdf417(value, options));
        /* Reset alignment */ if (this.#composer.align !== 'left') {
            this.#composer.add(this.#language.align('left'));
        }
        this.#composer.flush({
     ...
     */ image(input, width, height, algorithm, threshold) {
        ...
        /* Determine the type of the input */ const name = input.constructor.name;
        let type;
        ...
        /* Turn provided data into an ImageData object */ let image;
        if (type == 'element') {
        ...
        if (type == 'node-read-image') {
            image = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$canvas$2f$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](input.width, input.height);
            image.data.set(input.frames[0].data);
        }
        if (type == 'node-sharp') {
            image = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$canvas$2f$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](input.info.width, input.info.height);
            image.data.set(input.data);
        }
        if (type == 'ndarray') {
            image = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$canvas$2f$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](input.shape[0], input.shape[1]);
            image.data.set(input.data);
        }
        if (type == 'object') {
            image = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$canvas$2f$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](input.width, input.height);
        ...
        /* Resize image */ if (width !== image.width || height !== image.height) {
            image = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$resize$2d$image$2d$data$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(image, width, height, 'bilinear-interpolation');
        }
        /* Check if the image has the correct dimensions */ if (width !== image.width || height !== image.height) {
            throw new Error('Image could not be resized');
        }
        /* Flatten the image and dither it */ image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$flatten$2f$src$2f$canvas$2d$flatten$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].flatten(image, [
            0xff,
            0xff,
            0xff
        ]);
        switch(algorithm){
            case 'threshold':
                image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$dither$2f$src$2f$canvas$2d$dither$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].threshold(image, threshold);
                break;
            case 'bayer':
                image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$dither$2f$src$2f$canvas$2d$dither$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].bayer(image, threshold);
                break;
            case 'floydsteinberg':
                image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$dither$2f$src$2f$canvas$2d$dither$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].floydsteinberg(image);
                break;
            case 'atkinson':
                image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canvas$2d$dither$2f$src$2f$canvas$2d$dither$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].atkinson(image);
                break;
        }
        this.#composer.flush({
            forceFlush: true,
        ...
        /* Encode the image data */ this.#composer.add(this.#language.image(image, width, height, this.#options.imageMode));
        /* Reset alignment */ if (this.#composer.align !== 'left') {
            this.#composer.add(this.#language.align('left'));
        }
        this.#composer.flush({
   ...
   */ #encodeText(value, codepage) {
        if (codepage === null) {
            const fragment = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, 'ascii');
            return [
                {
                    type: 'text',
                    payload: [
        ...
        if (codepage !== 'auto') {
            const fragment = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(value, codepage);
        ...
        const fragments = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$point$2d$of$2d$sale$2f$codepage$2d$encoder$2f$dist$2f$codepage$2d$encoder$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].autoEncode(value, this.#codepageCandidates);
        const buffer = [];
   ...
   */ commands() {
        ...
        /* Determine if the last command is a pulse or cut, the we do not need a flush */ let lastLine = this.#queue[this.#queue.length - 1];
        if (lastLine) {
            let lastCommand = lastLine[lastLine.length - 1];
            if (lastCommand && [
                'pulse',
                'cut'
            ].includes(lastCommand.type)) {
                requiresFlush = false;
            }
        }
        /* Flush the printer line buffer if needed */ if (requiresFlush && this.#options.autoFlush && !this.#options.embedded) {
            this.#composer.add(this.#language.flush());
        }
        /* Get the remaining from the composer */ const result = [];
        ...
        /* Process all lines in the queue */ while(this.#queue.length){
     ...
     */ encode(format) {
        /* Get the commands */ const commands = this.commands();
        if (format === 'commands') {
            return commands;
        }
        /* Build the lines */ const lines = [];
        for (const line of commands){
            ...
            for (const item of line.commands){
                if (item.type === 'text') {
                    ...
                    buffer.push(Object.assign(item, {
                        payload: this.#encodeStyle(item.property, item.value)
                    }));
        ...
        /* If the last command is a pulse, do not feed */ if (last && last.type === 'pulse') {
...
//# sourceMappingURL=dc052_receipt-printer-encoder_dist_receipt-printer-encoder_mjs_4f039cea._.js.map