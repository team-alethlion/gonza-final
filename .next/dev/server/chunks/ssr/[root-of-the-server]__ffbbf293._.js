...
"[project]/src/utils/generateSubscriptionInvoice.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const generateSubscriptionInvoice = async (payment, type = 'invoice')=>{
    ...
    currentY += 5;
    doc.setFont('helvetica', 'normal');
    doc.text(`Date: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(payment.created_at), 'MMM dd, yyyy')}`, margins.left, currentY);
    // Add Due Date if provided (important for upcoming invoices)
    if (payment.due_date) {
        doc.text(`Due Date: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(payment.due_date), 'MMM dd, yyyy')}`, pageWidth - margins.right, currentY, {
            align: 'right'
        });
    }
    currentY += 5;
    doc.text(`Time: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(payment.created_at), 'hh:mm aa')}`, margins.left, currentY);
    currentY += 10;
    ...
    doc.text(`UGX ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$numberToWords$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["numberToWords"])(payment.amount)} only`, margins.left, currentY);
    currentY += 15;
    currentY += 5;
    // 9. Footer
    doc.setFont('helvetica', 'bold');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffbbf293._.js.map