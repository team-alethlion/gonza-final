-- Migration: Fix Admin RPC Defaults (Location Limit 1, Days Remaining 30)
-- Created: 2026-02-20
-- Purpose: Update get_platform_user_summary to use correct fallbacks matching the new trial defaults.
...
BEGIN
    ...
    SELECT jsonb_agg(jsonb_build_object(
        ...
        -- FIXED: Default location limit is now 1, not 3
        ...
        -- FIXED: Default days remaining is 30. 
        -- Logic: If next_billing_date is explicitly set and past, it's 0. 
        -- If it's NULL (no record), we default to 30 trial days.
        'days_remaining', CASE 
