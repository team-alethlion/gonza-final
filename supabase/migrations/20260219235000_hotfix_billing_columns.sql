-- Migration: Hotfix Missing Billing Columns in user_account_status
-- Created: 2026-02-19

DO $$
BEGIN
    -- 1. Ensure columns exist in user_account_status
...
-- 2. Re-create the get_platform_user_summary RPC to ensure it's synced with the new schema
